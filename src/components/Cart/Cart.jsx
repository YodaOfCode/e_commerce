...
const Cart = ({cart, handleUpdateCartQty, handleRemoveFromCart, handleEmptyCart}) => {
    ...
    const EmptyCart = () => (
        <Typography variant='subtitle1'>В корзине нет вещей,
            <Link className={classes.link} to='/'>начни добавлять что-то!</Link>
        </Typography>
    )
            ...
            <div className={classes.cardDetails}>
                ...
                <div>
                    <Button className={classes.emptyButton} size='large' type='button' variant='contained'
                            color='secondary' onClick={handleEmptyCart}>Очистить корзину</Button>
